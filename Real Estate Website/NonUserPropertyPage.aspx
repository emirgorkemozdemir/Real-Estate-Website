<%@ Page Title="" Language="C#" MasterPageFile="~/NonUser.Master" AutoEventWireup="true" CodeBehind="NonUserPropertyPage.aspx.cs" Inherits="Asp_Emlak_Sitesi_Kurs.NonUserPropertyPage" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:DataList ID="DataList1" runat="server">
        <ItemTemplate>
            <a href="NonUserPropertDetails.aspx?selectedid=<%# Eval("PropertyID") %>">
